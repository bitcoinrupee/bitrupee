...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitrupee repository."
  exit 1
fi
...
# See https://github.com/bitrupee/bitrupee/issues/16064
...
echo 'When compiling bitrupeed, run `./configure` in the following way:'
echo
