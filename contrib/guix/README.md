# Bootstrappable Bitrupee Core Builds

This directory contains the files necessary to perform bootstrappable Bitrupee
Core builds.
...
From the top of a clean Bitrupee Core repository:
...
To use dongcarl's substitute server for Bitrupee Core builds after having
