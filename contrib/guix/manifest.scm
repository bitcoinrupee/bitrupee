...
(define* (make-bitrupee-cross-toolchain target
                                       #:key
...
desirable for building Bitrupee Core release binaries."
...
(define glibc-2.27/bitrupee-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-bitrupee-cross-toolchain target #:base-libc glibc-2.27/bitrupee-patched))
                       (else
                        (make-bitrupee-cross-toolchain target)))))
