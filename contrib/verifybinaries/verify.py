...
bitrupeecore.org and bitrupee.org and compares them.
...
WORKINGDIR = "/tmp/bitrupee_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://bitrupeecore.org"
HOST2 = "https://bitrupee.org"
VERSIONPREFIX = "bitrupee-core-"
...
def main(args):
    ...
    if not success:
        print("bitrupee.org failed to provide signature file, "
              "but bitrupeecore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("bitrupee.org and bitrupeecore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Bitrupee Core binary release "
