Bitrupee-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitrupeerupee/files/Bitrupee/bitrupeerupee-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitrupee
...
New/changed settings (command-line or bitrupeerupee.conf file)
--------------------------------------------------------
