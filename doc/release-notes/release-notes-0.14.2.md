Bitrupee Core version 0.14.2 is now available from:

  <https://bitrupeerupee.org/bin/bitrupeerupee-core-0.14.2/>
...
(in Bitrupee Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate bitrupeerupee-config.h as necessary (theuni)
