Bitrupee Core version 0.13.2 is now available from:

  <https://bitrupeerupee.org/bin/bitrupeerupee-core-0.13.2/>
...
- #8908 `4a974b2` Update bitrupeerupee-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitrupeerupee-tx to create v2 transactions (btcdrak)
