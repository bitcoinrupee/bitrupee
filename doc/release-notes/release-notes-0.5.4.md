Bitrupee version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitrupeerupee/files/Bitrupee/bitrupeerupee-0.5.4/
...
http://gitorious.org/bitrupeerupee/bitrupeerupeed-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitrupee-Qt notifications under Growl 1.3.
Increase required age of Bitrupee-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitrupee properly when installing Bitrupee-Qt over it. (Windows)
