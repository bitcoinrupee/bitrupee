Bitrupee Core version *0.15.2* is now available from:

  <https://bitrupeerupeecore.org/bin/bitrupeerupee-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitrupeerupee-tx (TheBlueMatt)
