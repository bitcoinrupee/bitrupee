Bitrupee Core version 0.16.1 is now available from:

  <https://bitrupeerupeecore.org/bin/bitrupeerupee-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitrupeerupeed with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitrupeerupeed processes are cleaned up when tests end (sdaftuar)
