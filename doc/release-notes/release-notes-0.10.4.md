Bitrupee Core version 0.10.4 is now available from:

  <https://bitrupeerupee.org/bin/bitrupeerupee-core-0.10.4/>
...
- #6953 `43c2789` Split bitrupeerupee-tx into its own package
- #6953 `dfe0d4d` Include bitrupeerupee-tx binary on Debian/Ubuntu
