...
// Copyright (c) 2009-2019 The Bitrupee Core developers
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitrupeed
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Bitrupee is not connected
