// Copyright (c) 2019 The Bitrupee Core developers
...
/* A AEAD class for ChaCha20-Poly1305@bitrupee.
 *
 ...
 *
 * The chacha20-poly1305@bitrupee combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitrupee cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitrupee are relatively fast in
