 ...
 * for both bitrupeed and bitrupee-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/bitrupee/bips/blob/master/bip-0014.mediawiki)
 */
