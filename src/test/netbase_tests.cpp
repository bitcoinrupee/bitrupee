...
{
    BOOST_CHECK(TestSplitHost("www.bitrupeecore.org", "www.bitrupeecore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bitrupeecore.org]", "www.bitrupeecore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bitrupeecore.org:80", "www.bitrupeecore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitrupeecore.org]:80", "www.bitrupeecore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:26146", "127.0.0.1", 26146));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:26146", "127.0.0.1", 26146));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:26146", "::ffff:127.0.0.1", 26146));
    BOOST_CHECK(TestSplitHost("[::]:26146", "::", 26146));
    BOOST_CHECK(TestSplitHost("::26146", "::26146", 0));
    BOOST_CHECK(TestSplitHost(":26146", "", 26146));
    BOOST_CHECK(TestSplitHost("[]:26146", "", 26146));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:26146", "127.0.0.1:26146"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:26146", "[::]:26146"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
