...
//! Entry point for BitrupeeApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitrupeeApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitrupeeGUI tests.
void AppTests::guiTests(BitrupeeGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitrupeeGUI::consoleShown, this, &AppTests::consoleTests);
