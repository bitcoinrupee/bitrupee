    ...
    platformStyle(_platformStyle)
{
    ...
    // normal bitrupee address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying bitrupee address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BitrupeeAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
