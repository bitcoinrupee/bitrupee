...
/**
  Bitrupee GUI main class. This class represents the main window of the Bitrupee UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BitrupeeGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BitrupeeGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BitrupeeGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bitrupee wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Bitrupee Transaction from file or clipboard */
