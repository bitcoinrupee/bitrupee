    ...
    mapper(nullptr)
{
    ...
    ui->bitrupeeAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitrupeeAtStartup);
    ...
    ui->bitrupeeAtStartup->setToolTip(ui->bitrupeeAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitrupeeAtStartup->setText(ui->bitrupeeAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitrupeeConfButton->setToolTip(ui->openBitrupeeConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitrupeeUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitrupeeAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitrupeeConfButton_clicked()
{
