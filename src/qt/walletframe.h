 ...
 * controls into BitrupeeGUI. The purpose of this class is to allow future
 * refinements of the wallet controls with minimal need for further
 * modifications to BitrupeeGUI, thus greatly simplifying merges while
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Bitrupee Transaction */
