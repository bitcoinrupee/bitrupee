...
// bitrupee includes.
#include <..\src\script\bitrupeeconsensus.h>
...
int main()
{
    std::cout << "bitrupeeconsensus version: " << bitrupeeconsensus_version() << std::endl;
    ...
    auto op0Result = bitrupeeconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, bitrupeeconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
