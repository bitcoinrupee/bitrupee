...
class TestBitrupeeCli(BitrupeeTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitrupee-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and bitrupee-cli getwalletinfo return expected wallet info")
            ...
            # Test bitrupee-cli -generate with -rpcwallet in multiwallet mode.
