...
class ZMQTest (BitrupeeTestFramework):
    ...
    def test_sequence(self):
        ...
        [seq] = self.setup_zmq_test([("sequence", "tcp://127.0.0.1:226146")])
        self.disconnect_nodes(0, 1)
