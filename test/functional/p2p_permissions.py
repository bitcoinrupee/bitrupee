...
class P2PPermissionsTests(BitrupeeTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitrupeeconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bitrupeeconf, 'w', encoding="utf8") as f:
            f.write(newText)
