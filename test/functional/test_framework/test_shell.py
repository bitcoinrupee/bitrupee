...
class TestShell:
    """Wrapper Class for BitrupeeTestFramework.

    The TestShell class extends the BitrupeeTestFramework
    ...
    class __TestShell(BitrupeeTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitrupeeTestFramework child class.
            self.num_nodes = 1
