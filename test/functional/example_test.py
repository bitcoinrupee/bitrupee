...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitrupeeTestFramework
    pass


class ExampleTest(BitrupeeTestFramework):
    # Each functional test is a subclass of the BitrupeeTestFramework class.
    ...
    def custom_method(self):
        ...
        BitrupeeTestFramework class so other tests can use it."""
