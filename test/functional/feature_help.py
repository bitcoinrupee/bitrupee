...
"""Verify that starting bitrupee with -h works as expected."""

from test_framework.test_framework import BitrupeeTestFramework
from test_framework.util import assert_equal

class HelpTest(BitrupeeTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitrupee with -h for help text")
        ...
        self.log.info("Start bitrupee with -version for version information")
        ...
        self.log.info("Start bitrupeed with -fakearg to make sure it does not start")
