...
By default, bitrupeed will dump mempool on shutdown and
...
class MempoolPersistTest(BitrupeeTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitrupeed from writing mempool.dat to disk. Verify that `savemempool` fails")
