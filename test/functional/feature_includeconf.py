#!/usr/bin/env python3
# Copyright (c) 2018-2019 The Bitrupee Core developers
...
class IncludeConfTest(BitrupeeTestFramework):
    ...
    def setup_chain(self):
        ...
        with open(os.path.join(self.options.tmpdir, "node0", "bitrupee.conf"), "a", encoding='utf8') as f:
