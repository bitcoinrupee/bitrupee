...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Bitrupee
else
  DOCKER_EXEC echo \> \$HOME/.bitrupee
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/bitrupee/bitrupee/pull/18288#discussion_r433189350 for
  # details.
